...
static struct alsps_hw G700T_cust_alsps_hw = {
    .i2c_num    = 3,
	.polling_mode_ps =0,
	.polling_mode_als =1,
    .power_id   = MT65XX_POWER_NONE,    /*LDO is not used*/
...
static struct alsps_hw G610T_cust_alsps_hw = {
    .i2c_num    = 3,
	.polling_mode_ps =0,
	.polling_mode_als =1,
    .power_id   = MT65XX_POWER_NONE,    /*LDO is not used*/
...
struct alsps_hw *get_cust_alsps_hw(void) 
{
    ...
    if((boardType & HW_VER_MAIN_MASK) == HW_G700_VER)
        return &G700T_cust_alsps_hw;
	else if((boardType & HW_VER_MAIN_MASK) == HW_G610_VER)
        return &G610T_cust_alsps_hw;

    else
    {
       return &G700T_cust_alsps_hw; /*use the default direction*/
    }
...
int TMD2771_G700T_CMM_PPCOUNT_VALUE = 0x04;
int TMD2771_G610T_CMM_PPCOUNT_VALUE = 0x04;
int ZOOM_TIME = 5;
